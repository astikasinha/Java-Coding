public class STARTINGLL{
    ...
    public static void main(String[] args){
        ...
        System.out.println(x.next.data);//data of next element using previous elememnt.This way we can access all the elements(simple process we will later use head and tail concept)
        displayr(x);
        displayreverse(x);
